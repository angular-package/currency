...
<!-- npm badge -->
[![npm version][currency-npm-badge-svg]][currency-npm-badge]

<!-- GitHub badges -->
[![GitHub issues][currency-badge-issues]][currency-issues]
[![GitHub forks][currency-badge-forks]][currency-forks]
[![GitHub stars][currency-badge-stars]][currency-stars]
[![GitHub license][currency-badge-license]][currency-license]
<!-- Sponsors badges -->
...
For the detailed documentation go to [**https://currency.angular-package.dev**](https://currency.angular-package.dev)
...
Copy this package to the `packages/currency` folder of the [library skeleton][skeleton] then run the commands below.
...
Run `ng build currency` to build the project. The build artifacts will be stored in the `dist/currency` directory.
...
Install `@angular-package/currency` package with command:

```bash
npm i @angular-package/currency --save
```
...
The **changelog** of this package is based on [*keep a changelog*](https://keepachangelog.com/en/1.0.0/). To read it, click on the [CHANGELOG.md](https://github.com/angular-package/currency/blob/main/CHANGELOG.md) link.
...
MIT © angular-package ([license][currency-license])
...
<!-- This package: currency  -->
  <!-- GitHub: badges -->
  [currency-badge-issues]: https://img.shields.io/github/issues/angular-package/currency
  [currency-badge-forks]: https://img.shields.io/github/forks/angular-package/currency
  [currency-badge-stars]: https://img.shields.io/github/stars/angular-package/currency
  [currency-badge-license]: https://img.shields.io/github/license/angular-package/wrapper
  <!-- GitHub: badges links -->
  [currency-issues]: https://github.com/angular-package/currency/issues
  [currency-forks]: https://github.com/angular-package/currency/network
  [currency-license]: https://github.com/angular-package/currency/blob/master/LICENSE
  [currency-stars]: https://github.com/angular-package/currency/stargazers
<!-- This package -->
  [currency-github-changelog]: https://github.com/angular-package/currency/blob/main/CHANGELOG.md
