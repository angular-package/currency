...
// Interface.
import { CurrencyValueOptions } from '../interface/currency-value-options.interface';
/**
 *
 */
...
> extends Number<Value> {
  ...
  public get formatted(): string {
    return CurrencyValue.format(this.valueOf(), this.resolvedOptions);
  }
  ...
  #formatAsCurrency<PickCurrency extends Currency | Currencies>(
    ...
    return CurrencyValue.formatAsCurrency(this.valueOf(), currency, {
